<!-- authors_select.php | visualizar las publicaciones realizas por el usuario seleccionado -->
    ...
    if (mysqli_num_rows($result) >= 1) {
        ...
        <div class="container text-center">
            ...
            <form class="p-3 mb-2 bg-light text-dark card card-body ">
                ...
                <a href="authors.php"><button type="button" class="btn btn-primary btn-lg btn-block"> Volver </button></a>
            </form>
            </div>
